...
/******************************************************************************
* This is the constructor for the business class. It sets all necessary
 ...
 ******************************************************************************/
    public Business(String name, String details, LocalDate due,
                    String location, double duration) {
        setName(name);
        setDetails(details);
        setDue(due);
 ...
 * @return eventString a string of a Business
 *****************************************************************************/
    ...
    @Override
    /**************************************************************************
     * Compares an Object to Business objects and returns if their members are
     * equal.
